...
@Slf4j
public class StackRarityOverlay extends WidgetItemOverlay
{
    private static final int INVENTORY_SIZE = 28;

    private final StackRarityPlugin plugin;
    private final ItemManager itemManager;

    @Inject
    private StackRarityOverlay(StackRarityPlugin plugin, ItemManager itemManager)
    {
        this.plugin = plugin;
